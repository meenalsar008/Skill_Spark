...
import emailIcon from "../Admin/images/email.png";
import notifications from "../Admin/images/notifications.png";
import Navbar from "../Class/Navbar/classNavbar.js";
import login from "../Admin/images/login.png";
                    ...
                    <h1>Update Page</h1>
                        {item ? (
                            <div class="item-details">
                                ...
                                <button style={{ marginLeft: '180px' }} onClick={loginUser}>Submit</button>
                            </div>
                        ) : (
